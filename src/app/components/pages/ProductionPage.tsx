            ...
            <GlassCard data-testid="step-adjustment-panel" pad={16} style={{ marginBottom: 12 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 10 }}>
                <div>
                  ...
                  <p style={{ ...T.label, color: C.t3, marginTop: 3 }}>可选操作：可直接编辑或继续修改，想比较就生成候选。</p>
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                <button onClick={handleRevise} disabled={generating} data-state={revisionReady ? 'ready' : 'idle'} style={{ ...reviseButtonStyle, display: 'flex', alignItems: 'center', gap: 6, padding: '8px 16px', borderRadius: 10 }}><RefreshCw size={13} />{generating ? '重新生成中…' : '继续修改'}</button>
