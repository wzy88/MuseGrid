...
export const THEME_VALUES = {
  ...
  light: {
    '--mg-bg0': '#DDE4EF',
    '--mg-bg1': '#E8EDF5',
    '--mg-bg-card': 'rgba(248,250,253,0.72)',
    '--mg-bg-raised': 'rgba(242,246,251,0.9)',
    '--mg-bg-hover': 'rgba(79,70,229,0.09)',
    '--mg-border-0': 'rgba(32,42,61,0.13)',
    '--mg-border-1': 'rgba(32,42,61,0.18)',
    '--mg-text-0': 'rgba(18,27,44,0.96)',
    '--mg-text-1': 'rgba(18,27,44,0.76)',
    '--mg-text-2': 'rgba(18,27,44,0.58)',
    '--mg-text-3': 'rgba(18,27,44,0.42)',
    '--mg-shell': 'rgba(232,237,245,0.9)',
    '--mg-topbar': 'rgba(232,237,245,0.8)',
    '--mg-line-subtle': 'rgba(32,42,61,0.12)',
    '--mg-shadow-card': 'inset 0 1px 0 rgba(255,255,255,0.72), 0 14px 34px rgba(37,50,72,0.1)',
  },
} as const;
